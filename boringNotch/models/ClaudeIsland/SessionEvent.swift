...
enum SessionEvent: Sendable {
    ...
    case historyLoaded(sessionId: String, messages: [ChatMessage], completedTools: Set<String>, toolResults: [String: ConversationParser.ToolResult], structuredResults: [String: ToolResultData], conversationInfo: ConversationInfo, model: String?, tokenUsage: TokenUsage?, gitBranch: String?, todos: [ClaudeTodoItem])
}
...
extension SessionEvent: CustomStringConvertible {
    nonisolated var description: String {
        ...
        case .historyLoaded(let sessionId, let messages, _, _, _, _, _, _, _, _):
