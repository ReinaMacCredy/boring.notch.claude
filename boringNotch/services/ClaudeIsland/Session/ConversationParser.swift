...
actor ConversationParser {
    ...
    func parse(sessionId: String, cwd: String) -> ConversationInfo {
        ...
        let sessionFile = realHomeDirectory() + "/.claude/projects/" + projectDir + "/" + sessionId + ".jsonl"
    ...
    private static func sessionFilePath(sessionId: String, cwd: String) -> String {
        let projectDir = cwd.replacingOccurrences(of: "/", with: "-").replacingOccurrences(of: ".", with: "-")
        return realHomeDirectory() + "/.claude/projects/" + projectDir + "/" + sessionId + ".jsonl"
    }
    ...
    func parseSubagentTools(agentId: String, cwd: String) -> [SubagentToolInfo] {
        ...
        let projectDir = cwd.replacingOccurrences(of: "/", with: "-").replacingOccurrences(of: ".", with: "-")
        let agentFile = realHomeDirectory() + "/.claude/projects/" + projectDir + "/agent-" + agentId + ".jsonl"
