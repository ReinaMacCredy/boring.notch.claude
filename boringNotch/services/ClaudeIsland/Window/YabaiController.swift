...
actor YabaiController {
    ...
    private func focusTmuxInstance(claudePid: Int, tree: [Int: ClaudeProcessInfo], windows: [YabaiWindow]) async -> Bool {
    ...
    private func findTmuxClientTerminal(forSession session: String, tree: [Int: ClaudeProcessInfo], windows: [YabaiWindow]) async -> Int? {
    ...
    private func focusTmuxPane(forWorkingDir workingDir: String, tree: [Int: ClaudeProcessInfo], windows: [YabaiWindow]) async -> Bool {
